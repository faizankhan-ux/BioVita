...
// If it's not available, we'll use a simplified line splitting logic.
// For now, we'll try to import it as requested.
// If it fails, we'll need to use a different approach.
