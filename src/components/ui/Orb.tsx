...
export default function Orb({
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      // Trigger only when the cursor is over the "Ring" (approx 0.4 to 1.0)
    ...
    const handleMouseLeave = () => {
      // We don't necessarily want to reset if listening on window, 
      // but if the mouse leaves the viewport it's fine.
    };
